#!/usr/bin/env python3
"""Run or validate the frozen v13 paired instruction-attack study."""
...
from scripts import run_l2_predictive_virtual_brake_v13_fresh3 as online  # noqa: E402
...
AUTHORIZED_STATUS = (
    "authorized_v13_predictive_virtual_brake_attacked"
)
STAGE = "predictive_virtual_brake_v13_attacked_scale45"
DEFAULT_PROTOCOL = (
    REPO_ROOT
    / "experiments"
...
def _attacked_enrich(
    ...
    return {
        **enriched,
        "method_claim": (
            "exploratory paired instruction-attack evaluation of the "
            "target-joint predictive simulator virtual brake"
        ),
...
def _patched_attacker() -> Iterator[None]:
    ...
    base._v10_metrics = _attacked_metrics
    physical._enrich = _attacked_enrich
    ...
    *,
    ...
    return {
        **report,
        ...
        "clean_gate_prerequisite_passed": True,
        "outcome_gates_are_descriptive_only": True,
    }
