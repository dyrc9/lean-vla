#!/usr/bin/env python3
"""Execute a frozen v3 L1 collection through the audited v1 collector."""
...
from scripts.run_l1_task_conditioned_successor_v3 import (  # noqa: E402
    annotate_payload,
    patched_task_conditioned_l1_v3_runtime,
)
...
def execute(protocol_path: Path, policy_gpu: int, egl_gpu: int) -> dict[str, Any]:
    ...
    collector.patched_task_conditioned_l1_runtime = patched_task_conditioned_l1_v3_runtime
...
def main() -> int:
    ...
    print(json.dumps(execute(args.protocol.resolve(), args.policy_gpu, args.egl_gpu), indent=2, sort_keys=True))
    return 0
