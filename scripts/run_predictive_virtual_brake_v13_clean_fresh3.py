#!/usr/bin/env python3
"""Run or validate the frozen v13 clean fresh3 full repeat."""
...
AUTHORIZED_STATUS = (
    "authorized_v13_predictive_virtual_brake_clean_outcome_fresh3"
)
DEFAULT_PROTOCOL = (
    REPO_ROOT
    / "experiments"
    ...
    *,
    ...
    return {
        **report,
        ...
        "fresh3_full_repeat": True,
        "fresh2_partial_outcomes_observed": True,
        "scientific_parameters_changed_after_fresh2": False,
    }
