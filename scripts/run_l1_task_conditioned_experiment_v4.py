#!/usr/bin/env python3
"""Execute a frozen v4 L1 collection through the audited v1 collector."""
...
from scripts.run_l1_task_conditioned_successor_v4 import (  # noqa: E402
    annotate_payload,
...
def main() -> int:
    ...
    print(
        json.dumps(
            execute(args.protocol.resolve(), args.policy_gpu, args.egl_gpu),
            indent=2,
            sort_keys=True,
        )
    )
