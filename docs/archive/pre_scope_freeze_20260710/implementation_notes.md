...
examples. The Lean monitor accumulates accepted symbolic history across prefixes;
Python also digest-binds accepted events and the episode nonce, but the two
temporal languages still require a canonical wire format and differential parity
before Lean becomes the online CTDA evaluator.
