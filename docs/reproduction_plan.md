...
2. SABER exact-task R1 已在第一个 record-generation artifact gate fail closed；保留 raw audit，禁止重试；
3. Phantom/SABER 两条条件式 scoped main 均未获授权，不运行；
4. 新实验线必须重新事前定义，不能复活上述 invalid SABER record；
