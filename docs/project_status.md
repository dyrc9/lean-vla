...
| attack foundation | SABER P0 terminal nonpass；EDPA P1a runtime paused | Phantom held-out 1/4；SABER R7 为 8/8 valid episode、1/4 typed transition，均未达到 2/4 gate；EDPA P1a 双相机原始定义 patch 资产已完成且静态预检通过，但尚无任何 P1 rollout | qualified attack count 仍为 0；P1a 仅可在空闲 GPU 上继续独立 VLA-only qualification，旧 EDPA R0 不可执行，禁止防御比较 |
