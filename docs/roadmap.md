...
dispatch 的相同 12 pairs。独立 E3 clean safety 已通过，但不恢复 E1/E2 utility/duality gate。安全主线
下一步只能是不同、事前冻结且带独立 simulator oracle 的 post-dispatch intervention/fallback challenge；
deadline/latency 仅保留诊断，仍禁止 real-time claim。
