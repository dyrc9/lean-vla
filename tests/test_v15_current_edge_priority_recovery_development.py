...
from scripts import (
    freeze_v15_current_edge_priority_recovery_development as freezer,
)


def test_priority_successor_retains_population_arms_and_seeds() -> None:
...
def test_frozen_priority_protocol_is_current_when_present() -> None:
