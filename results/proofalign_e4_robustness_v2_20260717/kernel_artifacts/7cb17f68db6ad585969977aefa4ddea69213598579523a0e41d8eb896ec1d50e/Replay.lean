...
def replayRequest : PrefixPrePayload :=
  {
    ...
    authorizationStateDigest := (String.mk [Char.ofNat 115, Char.ofNat 116, Char.ofNat 97, Char.ofNat 108, Char.ofNat 101, Char.ofNat 45, Char.ofNat 115, Char.ofNat 116, Char.ofNat 97, Char.ofNat 116, Char.ofNat 101])
