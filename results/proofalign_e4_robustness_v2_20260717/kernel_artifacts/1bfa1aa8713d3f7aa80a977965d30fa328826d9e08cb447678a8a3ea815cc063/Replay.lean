...
def replayRequest : MonitorPayload :=
  {
    ...
    recordMonitorBeforeDigest := (String.mk [Char.ofNat 111, Char.ofNat 116, Char.ofNat 104, Char.ofNat 101, Char.ofNat 114, Char.ofNat 45, Char.ofNat 109, Char.ofNat 111, Char.ofNat 110, Char.ofNat 105, Char.ofNat 116, Char.ofNat 111, Char.ofNat 114])
...
example : checkMonitor replayRequest = MonitorResult.inconsistent := by decide
