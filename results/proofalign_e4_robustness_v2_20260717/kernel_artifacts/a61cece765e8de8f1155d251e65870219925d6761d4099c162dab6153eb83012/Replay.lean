...
def replayRequest : MonitorPayload :=
  {
    ...
    currentObservedAtoms := [(String.mk [Char.ofNat 99, Char.ofNat 111, Char.ofNat 108, Char.ofNat 108, Char.ofNat 105, Char.ofNat 115, Char.ofNat 105, Char.ofNat 111, Char.ofNat 110])]
...
example : checkMonitor replayRequest = MonitorResult.violated := by decide
