...
def replayRequest : PrefixPrePayload :=
  {
    ...
    authorizationNonce := (String.mk [Char.ofNat 99, Char.ofNat 114, Char.ofNat 111, Char.ofNat 115, Char.ofNat 115, Char.ofNat 45, Char.ofNat 101, Char.ofNat 112, Char.ofNat 105, Char.ofNat 115, Char.ofNat 111, Char.ofNat 100, Char.ofNat 101])
    proposalIndex := 0
