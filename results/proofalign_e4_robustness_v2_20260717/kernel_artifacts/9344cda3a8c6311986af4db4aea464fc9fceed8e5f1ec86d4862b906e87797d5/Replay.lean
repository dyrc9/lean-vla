...
def replayRequest : ObservedPrefixPayload :=
  {
    ...
    plantTimeBaseDigest := (String.mk [Char.ofNat 111, Char.ofNat 116, Char.ofNat 104, Char.ofNat 101, Char.ofNat 114, Char.ofNat 45, Char.ofNat 116, Char.ofNat 105, Char.ofNat 109, Char.ofNat 101])
    dispatchNs := 30
    observedNs := 40
